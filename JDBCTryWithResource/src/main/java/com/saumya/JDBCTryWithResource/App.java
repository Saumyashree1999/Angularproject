...
public class App {
	public static void main(String[] args) {
		...
		System.out.println(
				"-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
		try (Connection connection = mySqlConnection.getConnection(mySqlConnection.question1);
				PreparedStatement preparedStatement = connection.prepareStatement(mySqlConnection.question1)) {
			//PreparedStatement preparedStatement = connection.prepareStatement(mySqlConnection.question1);
			...
			System.out.println(
					"--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
//			preparedStatement = connection.prepareStatement(mySqlConnection.question2);
...
//					"----------------------------------------------------------------------------------------");
//
//			System.out.println(String.format(" " + "%-15s %-20s %-40s %-25s", "product id", "variant id",
//					"product name", "remaining"));
//			System.out.println(
//					"----------------------------------------------------------------------------------------");
//			preparedStatement = connection.prepareStatement(mySqlConnection.question3);
...
//						"----------------------------------------------------------------------------------------");
		...
		/*
		 * System.out.println("\n\n\n" +
		 * "2. Write a Query to search a product based on name?"); System.out.println(
		 * "-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
		 * ); // ResultSet resultSet2 = //
		 * mySqlConnection.getResultSet(mySqlConnection.question2);
		 * 
		 * System.out.println(String.format(
		 * "%-15s %-15s %-12s %-20s %-50s %-75s %-20s %-20s %-15s %-15s %-18s %-17s %-15s %-18s %-23s %-21s %-15s"
		 * , "product_id", "created_at", "deleted_at", "updated_at", "name",
		 * "description", "product number", "subtype id", "material id", "washcare id",
		 * "category id", "brand id", "subtype", "material", "washcare", "category",
		 * "brand ")); System.out.println(
		 * "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
		 * ); try (ResultSet resultSet2 =
		 * mySqlConnection.getResultSet(mySqlConnection.question2)) { while
		 * (resultSet2.next()) {
		 * 
		 * System.out.println(String.format(
		 * "%-15s %-20s %-8s %-15s %-30s %-100s %-25s %-15s %-20s %-15s" +
		 * " %-15s %-15s %-12s %-20s %-20s %-24s %-15s", resultSet2.getLong(1),
		 * resultSet2.getDate(2), resultSet2.getInt(3), resultSet2.getDate(4),
		 * resultSet2.getString(5), resultSet2.getString(6), resultSet2.getString(7),
		 * resultSet2.getLong(8), resultSet2.getLong(9), resultSet2.getLong(10),
		 * resultSet2.getLong(11), resultSet2.getLong(12), resultSet2.getString(13),
		 * resultSet2.getString(14), resultSet2.getString(15), resultSet2.getString(16),
		 * resultSet2.getString(17))); System.out.println(
		 * "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
		 * ); } // mySqlConnection.closeConnection(); } catch (SQLException e) { // TODO
		 ...
		 * mySqlConnection.getResultSet(mySqlConnection.question3);
		 * System.out.println(String.format(" " + "%-15s %-20s %-40s %-25s",
		 * "product id", "variant id", "product name", "remaining"));
		 * System.out.println(
		 * "----------------------------------------------------------------------------------------"
		 * ); try (ResultSet resultSet3 =
		 * mySqlConnection.getResultSet(mySqlConnection.question3)) { while
		 * (resultSet3.next()) { System.out.println(String.format("  " +
		 * "%-20s %-7s %-50s %-15s", resultSet3.getLong(1), resultSet3.getLong(2),
		 * resultSet3.getString(3), resultSet3.getInt(4))); System.out.println(
		 * "----------------------------------------------------------------------------------------"
		 * ); } // mySqlConnection.closeConnection(); } catch (SQLException e) { // TODO
		 * Auto-generated catch block e.printStackTrace(); }
		 */
